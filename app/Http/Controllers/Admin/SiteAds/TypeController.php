...
{
    public function __construct(SiteAdsType $model)
    {
        $this->model = $model;
    }
    ...
    public function index()
    {
        if (request()->wantsJson()) {
            ...
            $all = view('components.admin.siteAdsType', [
                'types' => $types,
                'selector' => 'datatable-all',
            ])->render();

            $active = view('components.admin.siteAdsType', [
                'types' => $activeTypes,
                'selector' => 'datatable-active',
            ])->render();

            $inactive = view('components.admin.siteAdsType', [
                'types' => $inactiveTypes,
        ...
        return view(self::$viewDir.'siteAds.type');
    }
