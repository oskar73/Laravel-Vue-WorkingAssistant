...
class DirectoryAdsController extends UserController
{
    ...
    public function index()
    {
        ...
        return view(self::$viewDir.'directoryAds.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$viewDir.'directoryAds.edit', compact('listing'));
    }
    ...
    public function detail($id)
    {
        ...
        return view(self::$viewDir.'directoryAds.detail', compact('listing'));
    }
    ...
    public function tracking($id)
    {
        ...
        return view(self::$viewDir.'directoryAds.tracking', compact('listing'));
    }
...
//            $data['url'] = route('admin.directoryAds.listing.show', $item->id);
