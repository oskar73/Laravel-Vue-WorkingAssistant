...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('user.ticket.index')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-info  mb-2">Back</a>
        <a href="{{route('user.ticket.edit', $item->id)}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success  mb-2">Reply</a>
    </div>
@endsection
...
@section('script')
    ...
    <script src="{{asset('assets/js/user/ticket/itemShow.js')}}"></script>
@endsection
