...
@section('title', 'Directory Advertisement Listing Edit')
@section('style')
@endsection
@section('breadcrumb')
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Directory Ads Edit</span>
                </a>
            </li>
        </ul>
    </div>
...
@section('content')
    ...
    <form action="{{route('user.directoryAds.update', $listing->id)}}" id="submitForm">
        @csrf
...
@endsection
@section('script')
    <script>var g_type=@JSON($listing->type)</script>
    <script src="{{asset('assets/js/user/directoryAds/edit.js')}}"></script>
@endsection
