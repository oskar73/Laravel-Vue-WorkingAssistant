...
@section('title', 'Directory Advertisement Listing Detail')
@section('style')
@endsection
@section('breadcrumb')
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Directory Ads Detail</span>
                </a>
            </li>
        </ul>
    </div>
    <div class="col-md-6 text-right">
        <a href="{{route('user.directoryAds.index')}}" class="btn btn-outline-info m-btn m-btn--custom m-btn--square">Back</a>
        @if($listing->status!='expired')
            <a href="{{route('user.directoryAds.edit', $listing->id)}}" class="btn m-btn--square m-btn m-btn--custom btn-outline-success">Edit</a>
        @endif
    </div>
@endsection
                ...
                <div class="mt-3 border border-success p-2 pt-4">
                    <div class="row">
                        ...
                        <div class="col-md-5" x-data="{cta:{{$listing->cta_action? 'true': 'false'}}}">
                            ...
                            <div class="mt-5">
                                <a href="{{route('user.directoryAds.tracking', $listing->id)}}" class="underline">Total Clicks: {{$listing->current_number}}</a>
                            </div>
                        </div>
                    </div>
                </div>
