                        ...
                        <div class="quform-element mb-4">
                            <div class="quform-input">
                                ...
                                <div class="quform-submit-inner">
                                    <button class="btn text-theme-color m-0" type="button">
...
@endsection
@section('script')
    <script>var ecommerce_url = "{{route('ecommerce.index')}}"</script>
    <script src="{{asset('assets/js/front/ecommerce/index.js')}}"></script>
@endsection
