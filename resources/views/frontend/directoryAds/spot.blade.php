...
@section('title', $seo['meta_title']?? 'Directory Listing Advertisement Spots - ' . $spot->name)
...
@section('content')
    ...
    <form action="{{route('directoryAds.addtocart', $spot->id)}}" id="submitForm">
        @csrf
            ...
            <div class="search_append_area py-4">
                <div class="my-5">
                    ...
                    <div class="text-right">
                        <a href="{{route('directoryAds.index')}}" class="btn border-radius-none btn-outline-primary back_btn">Back</a>
        ...
        <div class="search_remove_area calendar_area mt-3 p-lg-5">
            <hr>
            <div class="row">
                <div class="col-md-8">
...
@section('script')
    ...
    <script>
        var g_price = `<?php echo json_encode($spot->standardPrice); ?>`,
            directoryads_spot = "{{route('directoryAds.spot', $spot->slug)}}",
            directoryads_url = "{{route('directoryAds.index')}}",
            directory_url="{{route('directory.index')}}";
    </script>
    <script src="{{asset('assets/js/front/directory/index.js')}}"></script>
    <script src="{{asset('assets/js/front/directoryAds/spot.js')}}"></script>
