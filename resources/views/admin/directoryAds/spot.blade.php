...
@section('title', 'Directory Listing Ads Spots')
@section('style')
@endsection
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.directoryAds.spot.create')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success mb-2">Create</a>
    </div>
@endsection
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/directoryAds/spot.js')}}"></script>
@endsection
