...
@section('title', 'Directory Ads Listing Create')
@section('style')
...
@section('content')
    <div class="tabs-wrapper">
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link" href="{{route('admin.directoryAds.listing.select')}}">Select Spot</a></li>
            <li class="tab-item"><a class="tab-link tab-active" data-area="#detail" href="javascript:void(0);">Listing Detail</a></li>
        </ul>
    </div>
    <form action="{{route('admin.directoryAds.listing.store', $spot->id)}}" id="submitForm">
        @csrf
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/directoryAds/listingCreate.js')}}"></script>
