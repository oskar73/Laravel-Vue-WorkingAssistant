...
@section('title', 'Directory Ads Listing')
@section('style')
...
@section('breadcrumb')
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Directory Advertisement</span>
                </a>
            </li>
            <li class="m-nav__separator">/</li>
            <li class="m-nav__item">
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.directoryAds.listing.select')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success createBtn mb-2">Create</a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="pending_area">
        <div class="m-portlet__body">
            @include("components.admin.directoryAdsListingTable", ['selector'=>'datatable-pending', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="all_area">
        <div class="m-portlet__body">
            @include("components.admin.directoryAdsListingTable", ['selector'=>'datatable-all', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="approved_area">
        <div class="m-portlet__body">
            @include("components.admin.directoryAdsListingTable", ['selector'=>'datatable-approved', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="denied_area">
        <div class="m-portlet__body">
            @include("components.admin.directoryAdsListingTable", ['selector'=>'datatable-denied', 'user'=>1])
        </div>
    </div>

    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="expired_area">
        <div class="m-portlet__body">
            @include("components.admin.directoryAdsListingTable", ['selector'=>'datatable-expired', 'user'=>1])
        </div>
    </div>

    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="new_area">
        <div class="m-portlet__body">
            @include("components.admin.directoryAdsListingTable", ['selector'=>'datatable-new', 'user'=>1])
        </div>
    </div>

@endsection
@section('script')
    <script src="{{asset('assets/js/admin/directoryAds/listing.js')}}"></script>
@endsection
