...
@section('title', 'Directory Listing Ads Front Setting')
@section('style')
@endsection
@section('breadcrumb')
...
@section('content')
    <div class="m-portlet m-portlet--mobile md-pt-50">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Directory Listing Ads Front Setting
                    </h3>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            <div class="container">
                <form action="{{route('admin.directoryAds.front.store')}}" id="submit_form">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="url" value="{{config("custom.route.directoryAds")}}">
                                        </div>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/directoryAds/front.js')}}"></script>
@endsection
