...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.directoryAds.listing.index')}}" class="btn m-btn--square m-btn m-btn--custom btn-outline-info">Back</a>
    </div>
@endsection
                    ...
                    <tbody>
                        @foreach($spots as $spot)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('admin.directoryAds.listing.create', $spot->slug)}}" class="btn btn-outline-info">Select</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    @foreach($spots as $spot)
                        <div class="col-lg-3 col-md-4 mb-3">
                            <div class="spot-grid h-100">
                                <a href="{{route('admin.directoryAds.listing.create', $spot->slug)}}" class="hover-none text-dark">
