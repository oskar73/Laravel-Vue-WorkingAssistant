...
@section('title', 'Directory Ads Listing Detail')
@section('style')
...
@section('breadcrumb')
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Directory Ads</span>
                </a>
            </li>
            <li class="m-nav__separator">/</li>
            <li class="m-nav__item">
                <a href="{{route('admin.directoryAds.listing.index')}}" class="m-nav__link">
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.directoryAds.listing.index')}}" class="btn btn-outline-info m-btn m-btn--custom m-btn--square">Back</a>
        <a href="{{route('admin.directoryAds.listing.edit', $listing->id)}}" class="btn m-btn--square m-btn m-btn--custom btn-outline-success">Edit</a>
    </div>
@endsection
            ...
            <div class="mt-3 border border-success p-2 pt-4">
                <div class="row">
                    ...
                    <div class="col-md-5" x-data="{cta:{{$listing->cta_action? 'true': 'false'}}}">
                        ...
                        <div class="mt-5 mb-5">
                            <a href="{{route('admin.directoryAds.listing.tracking', $listing->id)}}" class="underline">Total Clicks: {{$listing->current_number}}</a>
                        </div>
                        <hr>
                ...
                <div class="col-md-5">
                    <div class="table-responsive">
                        ...
                        <div class="form-group text-right">
                            <div class="font-size20">Total Price : $<span class="total_price">{{formatNumber($t_price?? 0)}}</span></div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/directoryAds/listingShow.js')}}"></script>
@endsection
