...
@section('content')
    <div class="m-portlet m-portlet--mobile md-pt-50">
        ...
        <div class="m-portlet__body">
            <div class="container">
                <form action="{{route('admin.ecommerce.front.store')}}" id="submit_form">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="url" value="{{ str_replace('/', '', $page->url ?? '') }}">
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8" x-data="{status:{{($front['nav_status'] ?? 0)==1?'true':'false'}}}">
                            <div class="form-group">
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/ecommerce/front.js')}}"></script>
@endsection
