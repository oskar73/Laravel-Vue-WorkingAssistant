...
@section('content')
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all"> All Customers (<span class="all_count">0</span>)</a></li>
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/ecommerce/customer.js')}}"></script>
@endsection
