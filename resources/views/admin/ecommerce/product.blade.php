...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.ecommerce.product.create')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success createBtn mb-2">Add New Product</a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all"> All Products (<span class="all_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#active" href="#/active"> Active Products (<span class="active_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#inactive" href="#/inactive"> InActive Products (<span class="inactive_count">0</span>)</a></li>
        </ul>
    </div>
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/ecommerce/product.js')}}"></script>
@endsection
