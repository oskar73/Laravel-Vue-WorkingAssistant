...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            ...
            <li class="tab-item"><a class="tab-link" href="{{route('admin.content.page.editContent', ['id'=>$page->id, 'type'=>$page->type])}}"> Edit Content</a></li>
        </ul>
    </div>
    <div class="m-portlet m-portlet--mobile md-pt-50 tab_area area-active">
        <div class="m-portlet__body">
            <div class="container">
                <form action="{{route('admin.content.page.update', $page->id)}}" id="submit_form">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control m-input m-input--square" name="name" id="name" value="{{$page->name}}">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="page-url" name="url" value="{{$page->url}}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group m-form__group">
                                    <span class="m-switch m-switch--outline m-switch--icon m-switch--info">
                                        <label>
                                            <input type="checkbox" {{$page->status==1? 'checked': ''}} id="status" name="status">
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                            ...
                            <div class="m-accordion__item-body collapse" id="accordion_body" role="tabpanel" aria-labelledby="accordion_head" data-parent="#accordion">
                                <div class="m-accordion__item-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control m-input m-input--square" name="title" id="title" value="{{$seo['meta_title']}}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control m-input m-input--square" name="keywords" id="keywords" value="{{$seo['meta_keywords']}}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative">
                                                    <textarea class="form-control m-input m-input--square minh-100px" name="description" id="description">{{$seo['meta_description']}}</textarea>
                                                </div>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="form-group m-form__group">
                                                ...
                                                <img src="{{$page->getFirstMediaUrl("seo")}}" id="preview" class="w-100 mt-3">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative">
                                            <textarea class="form-control m-input m-input--square minh-100px" name="head_code" id="head_code">{{$page->css}}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative">
                                            <textarea class="form-control m-input m-input--square minh-100px" name="bottom_code" id="bottom_code">{{$page->script}}</textarea>
                                        </div>
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/content/pageEdit.js')}}"></script>
@endsection
