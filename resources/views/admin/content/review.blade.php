...
@section('content')
    <div class="tab_btn_area text-center">
        <div class="show_checked d-none">
            ...
            <a href="javascript:void(0);" class="ml-auto btn m-btn--square m-btn--sm btn-outline-info switchBtn " data-action="inactive">Inactive</a>
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all"> All Reviews (<span class="all_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#active" href="#/active"> Active Reviews (<span class="active_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#inactive" href="#/inactive"> InActive Reviews (<span class="inactive_count">0</span>)</a></li>
        </ul>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="all_area">
        <div class="m-portlet__body">
            @include("components.admin.reviewTable", ['selector'=>'datatable-all'])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="active_area">
        <div class="m-portlet__body">
            @include("components.admin.reviewTable", ['selector'=>'datatable-active'])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="inactive_area">
        <div class="m-portlet__body">
            @include("components.admin.reviewTable", ['selector'=>'datatable-inactive'])
        </div>
    </div>
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/content/review.js')}}"></script>
@endsection
