                    ...
                    <div id="color_body">
                        ...
                        <div class="content">
                            <div class="colors pb-0 pt-3">
                                <form action="{{route("admin.setting.color.update", $color->id)}}" method="POST" id="submit_form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="gen text-center">
                                                    ...
                                                    <div class="child-color" ><input class="jscolor" value="{{$color->themeColor("primary")?? ''}}" id="js1" name="primary"></div>
                                                    <div class="hexcolor">
                                                        <h3>#17405B</h3>
                                   ...
                                   if theme color is black, we recommend this color as white.">
                                                    ...
                                                    <div class="child-color"><input class="jscolor" value="{{$color->themeColor("theme_font")?? ''}}" id="js2" name="theme_font"></div>
                                                    <div class="hexcolor">
                                                        <h3>#0A8BA1</h3>
                                                        <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                                        <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="gen text-center">
                                                    ...
                                                    <div class="child-color"><input class="jscolor" value="{{$color->themeColor("secondary")?? ''}}" id="js3"  name="secondary"></div>
                                                    <div class="hexcolor">
                                                        <h3>#09C1C5</h3>
                                                        <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                                        <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="gen text-center">
                                                    ...
                                                    <div class="child-color"><input class="jscolor" value="{{$color->themeColor("background")?? ''}}" id="js4" name="background"></div>
                                                    <div class="hexcolor">
                                                        <h3>#F1F3F4</h3>
                                                        <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                                        <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="gen text-center">
                                                    ...
                                                    <div class="child-color"><input class="jscolor" value="{{$color->themeColor("font")?? ''}}" id="js5" name="font"></div>
                                                    <div class="hexcolor">
                                                        <h3>#EA8971</h3>
                                                        <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                                        <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="gen text-center">
                                                    ...
                                                    <div class="child-color"><input class="jscolor" value="{{$color->themeColor("link")?? ''}}" id="js6" name="link"></div>
                                                    <div class="hexcolor">
                                                        <h3>#EA8971</h3>
                                                        <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                                        <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="gen text-center">
                                                    ...
                                                    <div class="child-color"><input class="jscolor" value="{{$color->themeColor("link_hover")?? ''}}" id="js7" name="link_hover"></div>
                                                    <div class="hexcolor">
                                                        <h3>#EA8971</h3>
                                                        <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                                        <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="gen text-center">
                                                    ...
                                                    <div class="child-color"><input class="jscolor" value="{{$color->themeColor("active_icon")?? ''}}" id="js8" name="active_icon"></div>
                                                    <div class="hexcolor">
                                                        <h3>#EA8971</h3>
                                                        <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                                        <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/setting/colorThemeEdit.js')}}"></script>
@endsection
