                    ...
                    <form action="{{route("admin.setting.color.update", $color->id)}}" method="POST" id="submit_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="m-portlet__head-tools mt-3 mb-3 text-right">
                                    <input type="text" class="form-control maxw-300 d-inline-block mr-2" name="name" placeholder="Name" value="{{$color->name}}">
                        ...
                        <div class="random-colors menu_colors">
                            <div class="gen text-center">
                                ...
                                <div class="child-color" ><input class="jscolor" id="js1" value="{{$color->themeColor("nav_bg")}}" name="nav_bg"></div>
                                <div class="hexcolor">
                                    <h3>#17405B</h3>
                            ...
                            <div class="gen text-center">
                                ...
                                <div class="child-color"><input class="jscolor" id="js2" value="{{$color->themeColor("nav_item")}}" name="nav_item"></div>
                                <div class="hexcolor">
                                    <h3>#0A8BA1</h3>
                                    <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                    <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                            ...
                            <div class="gen text-center">
                                ...
                                <div class="child-color"><input class="jscolor" id="js3" value="{{$color->themeColor("nav_hover_bg")}}" name="nav_hover_bg"></div>
                                <div class="hexcolor">
                                    <h3>#09C1C5</h3>
                                    <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                    <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
                            ...
                            <div class="gen text-center">
                                ...
                                <div class="child-color"><input class="jscolor" id="js4" value="{{$color->themeColor("nav_hover_item")}}" name="nav_hover_item"></div>
                                <div class="hexcolor">
                                    <h3>#F1F3F4</h3>
                                    <i class="jfa-copy tipso1" data-tipso="Copy"></i>
                                    <i class="jfa-lock tipso1" data-tipso="Lock/Unlock this color"></i>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/setting/colorMenuEdit.js')}}"></script>
