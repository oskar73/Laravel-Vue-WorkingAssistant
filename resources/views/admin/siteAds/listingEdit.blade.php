...
@section('title', 'Site Advertisement Listing Edit')
@section('style')
...
@section('content')
    ...
    <form action="{{route('admin.siteAds.listing.update', $listing->id)}}" id="submitForm">
        @csrf
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/siteAds/listingEdit.js')}}"></script>
