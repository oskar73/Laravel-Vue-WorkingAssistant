...
@section('title', 'Site Advertisement Listing Detail')
@section('style')
...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        ...
        <a href="{{route('admin.siteAds.listing.edit', $listing->id)}}" class="btn m-btn--square m-btn m-btn--custom btn-outline-success">Edit</a>
    </div>
@endsection
            ...
            <div class="mt-3 border border-success p-2 pt-4">
                <div class="row">
                    ...
                    <div class="col-md-5" x-data="{cta:{{$listing->cta_action? 'true': 'false'}}}">
                        ...
                        <div class="mt-5 mb-5">
                            <a href="{{route('admin.siteAds.listing.tracking', $listing->id)}}" class="underline">Total Clicks: {{$listing->current_number}}</a>
                        </div>
                        <hr>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/siteAds/listingShow.js')}}"></script>
@endsection
