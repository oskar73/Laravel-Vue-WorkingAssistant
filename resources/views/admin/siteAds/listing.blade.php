...
@section('title', 'Site Advertisement Listing')
@section('style')
...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.siteAds.listing.select')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success createBtn mb-2">Create</a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="pending_area">
        <div class="m-portlet__body">
            @include("components.admin.siteAdsListingTable", ['selector'=>'datatable-pending', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="all_area">
        <div class="m-portlet__body">
            @include("components.admin.siteAdsListingTable", ['selector'=>'datatable-all', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="approved_area">
        <div class="m-portlet__body">
            @include("components.admin.siteAdsListingTable", ['selector'=>'datatable-approved', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="denied_area">
        <div class="m-portlet__body">
            @include("components.admin.siteAdsListingTable", ['selector'=>'datatable-denied', 'user'=>1])
        </div>
    </div>

    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="expired_area">
        <div class="m-portlet__body">
            @include("components.admin.siteAdsListingTable", ['selector'=>'datatable-expired', 'user'=>1])
        </div>
    </div>

    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="new_area">
        <div class="m-portlet__body">
            @include("components.admin.siteAdsListingTable", ['selector'=>'datatable-new', 'user'=>1])
        </div>
    </div>

@endsection
@section('script')
    <script src="{{asset('assets/js/admin/siteAds/listing.js')}}"></script>
@endsection
