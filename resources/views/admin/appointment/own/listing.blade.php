...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile tab_area" id="all_area">
        <div class="m-portlet__body">
            ...
            @include("components.admin.appointmentTable", ['selector'=>'datatable-all', 'user'=> user()->id])
        </div>
    </div>
    @include("components.admin.addAppointmentModal")
@endsection
@section('script')
    <script src="{{ asset('assets/vendors/calendar/fullcalendar.js') }}"></script>
    <script src="{{asset('assets/js/admin/appointment/own/listing.js')}}"></script>
    <style>
        .pt-80{
            padding-top: 80px;
        }
