...
@section('title', 'Portfolio Front Setting')
@section('style')
@endsection
@section('breadcrumb')
...
@section('content')
    <div class="m-portlet m-portlet--mobile md-pt-50">
        ...
        <div class="m-portlet__body">
            <div class="container">
                <form action="{{route('admin.portfolio.front.store')}}" id="submit_form">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <h4>Front Header</h4>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="url" value="{{config("custom.route.portfolio")}}">
                                        </div>
