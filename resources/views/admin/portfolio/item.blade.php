...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.portfolio.item.create')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success mb-2">Create</a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all"> All Portfolios (<span class="all_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#active" href="#/active"> Active Portfolios (<span class="active_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#inactive" href="#/inactive"> InActive Portfolios (<span class="inactive_count">0</span>)</a></li>
        </ul>
    </div>
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/portfolio/item.js')}}"></script>
@endsection
