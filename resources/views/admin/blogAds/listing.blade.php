...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#new" href="#/new"> Newly Paid Listings (<span class="new_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link " data-area="#pending" href="#/pending"> Pending Approval (<span class="pending_count">0</span>)</a></li>
    ...
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="new_area">
        <div class="m-portlet__body">
