            ...
            @foreach($items as $item)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{route('blogAds.spot', $item->slug)}}" class="btn border-radius-none btn-outline-success outline_custom_btn">Select</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
                    ...
                    <div class="project-grid-style3">
                        <a href="{{route('blogAds.spot', $item->slug)}}" class="inner-box">
                            ...
                            <div class="project-desc pb-0">
                                ...
                                <span class="btn btn-success m-1 mt-3 border-radius-none font-size12 outline_custom_btn">
                                     Select
                                </span>
                            </div>
                        </a>
