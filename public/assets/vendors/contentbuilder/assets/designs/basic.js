    ...
    'designs': [
		    ...
		    'html':
                '<div class="is-section is-section-100 is-light-text is-box">' +
                    _tabs(1) + '<div class="is-overlay">' +
                        _tabs(2) + '<div class="is-overlay-bg" style="background-image: url([%IMAGE_PATH%]images/sample1.jpg);" data-bottom-top="transform:translateY(-120px) scale(1.05);" data-top-bottom="transform:translateY(120px) scale(1.05)"></div>' +
                        _tabs(2) + '<div class="is-overlay-color"></div>' +
                        _tabs(2) + '<div class="is-overlay-content"></div>' +
                    _tabs(1) + '</div>' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-centered is-opacity-95">' +
                            _tabs(3) + '<div class="is-container is-builder container is-content-800">' +
                    ...
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-centered">' +
                            _tabs(3) + '<div class="is-container is-builder container is-content-800">' +
                                _tabs(4) + '<div class="row clearfix">' +
                                    _tabs(5) + '<div class="column full">' +
                		                _tabs(6) + '<h1>Lorem Ipsum is dummy text</h1>' +
                                        _tabs(6) + '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
                                    _tabs(5) + '</div>' +
                                _tabs(4) + '</div>' +
                            _tabs(3) + '</div>' +
                        _tabs(2) + '</div>' +
...

        {
            ...
            'html':
                '<div class="is-section is-section-100 is-shadow-1">' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-4 is-box-img is-box">' +
                            _tabs(3) + '<div class="is-overlay">' +
                                _tabs(4) + '<div class="is-overlay-bg" style="background-image: url([%IMAGE_PATH%]images/sample1.jpg);" data-bottom-top="transform:translateY(-120px) scale(1.05);" data-top-bottom="transform:translateY(120px) scale(1.05)"></div>' +
                                _tabs(4) + '<div class="is-overlay-color"></div>' +
                                _tabs(4) + '<div class="is-overlay-content"></div>' +
                            _tabs(3) + '</div>' +
                         _tabs(2) + '</div>' +
                         _tabs(2) + '<div class="is-box-8 is-box">' +
                             _tabs(3) + '<div class="is-boxes">' +
                                 _tabs(4) + '<div class="is-box-centered">' +
                                     _tabs(5) + '<div class="is-container is-builder is-content-640 container">' +
                                         _tabs(6) + '<div class="row clearfix">' +
                                             _tabs(7) + '<div class="column full">' +
                                                 _tabs(8) + '<h1>Lorem Ipsum is simply dummy text of the printing industry</h1>' +
                                                 _tabs(8) + '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
                                             _tabs(7) + '</div>' +
                                         _tabs(6) + '</div>' +
                                     _tabs(5) + '</div>' +
                                 _tabs(4) + '</div>' +
...

		{
		    ...
		    'html':
                '<div class="is-section is-section-100 is-shadow-1">' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-6 is-light-text is-box">' +
                            _tabs(3) + '<div class="is-overlay">' +
                                _tabs(4) + '<div class="is-overlay-bg" style="background-image: url([%IMAGE_PATH%]images/sample1.jpg);" data-bottom-top="transform:translateY(-120px) scale(1.05);" data-top-bottom="transform:translateY(120px) scale(1.05)"></div>' +
                                _tabs(4) + '<div class="is-overlay-color"></div>' +
                                _tabs(4) + '<div class="is-overlay-content"></div>' +
                            _tabs(3) + '</div>' +
                            _tabs(3) + '<div class="is-boxes">' +
                                _tabs(4) + '<div class="is-box-centered is-opacity-90">' +
                                    _tabs(5) + '<div class="is-container is-builder is-content-500 container">' +
                                        _tabs(6) + '<div class="row clearfix">' +
                                            _tabs(7) + '<div class="column full">' +
            		                            _tabs(8) + '<div class="display">' +
                		                            _tabs(9) + '<h1>Lorem Ipsum is dummy text</h1>' +
                                                    _tabs(9) + '<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
            		                            _tabs(8) + '</div>' +
                                            _tabs(7) + '</div>' +
                                        _tabs(6) + '</div>' +
                                    _tabs(5) + '</div>' +
                            ...
                            _tabs(3) + '</div>' +
                        _tabs(2) + '</div>' +
                        _tabs(2) + '<div class="is-box-6 is-box">' +
                            _tabs(3) + '<div class="is-boxes">' +
                                _tabs(4) + '<div class="is-box-centered">' +
                                    _tabs(5) + '<div class="is-container is-builder is-content-500 container">' +
                                        _tabs(6) + '<div class="row clearfix">' +
                                            _tabs(7) + '<div class="column full">' +
                                                _tabs(8) + '<h1>Lorem Ipsum is simply dummy text</h1>' +
                                                _tabs(8) + '<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
                                            _tabs(7) + '</div>' +
                                        _tabs(6) + '</div>' +
                                    _tabs(5) + '</div>' +
                                _tabs(4) + '</div>' +
...

		{
		    ...
		    'html':
                '<div class="is-section is-section-100 is-shadow-1">' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-4 is-light-text is-box">' +
                            _tabs(3) + '<div class="is-overlay">' +
                                _tabs(4) + '<div class="is-overlay-bg" style="background-image: url([%IMAGE_PATH%]images/sample1.jpg);" data-bottom-top="transform:translateY(-120px) scale(1.05);" data-top-bottom="transform:translateY(120px) scale(1.05)"></div>' +
                                _tabs(4) + '<div class="is-overlay-color"></div>' +
                                _tabs(4) + '<div class="is-overlay-content"></div>' +
                            _tabs(3) + '</div>' +
                            _tabs(3) + '<div class="is-boxes">' +
                                 _tabs(4) + '<div class="is-box-centered is-opacity-90 is-content-bottom">' +
                                     _tabs(5) + '<div class="is-container is-builder is-content-500 container">' +
                                         _tabs(6) + '<div class="row clearfix">' +
                                             _tabs(7) + '<div class="column full">' +
                		                         _tabs(8) + '<h2>Lorem Ipsum</h2>' +
                                                 _tabs(8) + '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
                                             _tabs(7) + '</div>' +
                                         _tabs(6) + '</div>' +
                                     _tabs(5) + '</div>' +
                                 _tabs(4) + '</div>' +
                            ...
                            _tabs(3) + '<div class="is-boxes">' +
                                _tabs(4) + '<div class="is-box-centered is-opacity-90 is-content-bottom">' +
                                    _tabs(5) + '<div class="is-container is-builder is-content-500 container">' +
                                        _tabs(6) + '<div class="row clearfix">' +
                                            _tabs(7) + '<div class="column full">' +
                		                        _tabs(8) + '<h2>Lorem Ipsum is simply dummy text</h2>' +
                                                _tabs(8) + '<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>' +
                                            _tabs(7) + '</div>' +
                                        _tabs(6) + '</div>' +
                                    _tabs(5) + '</div>' +
...

		{
		    ...
		    'html':
                '<div class="is-section is-section-100 is-boxed-layout is-box">' +
                    ...
                    _tabs(1) + '</div>' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-centered is-opacity-90">' +
                            _tabs(3) + '<div class="is-container is-builder is-content-1100 container">' +
                                _tabs(4) + '<div class="row clearfix">' +
                                    _tabs(5) + '<div class="column full">' +
            		                    _tabs(6) + '<div class="display">' +
                		                    _tabs(7) + '<h1>Lorem Ipsum is simply dummy text of the printing industry</h1>' +
                                            _tabs(7) + '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
            		                    _tabs(6) + '</div>' +
                                    _tabs(5) + '</div>' +
                                _tabs(4) + '</div>' +
                    ...
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-6 is-box is-align-left is-bg-grey is-light-text">' +
                            ...
                            _tabs(3) + '<div class="is-boxes">' +
                              ...
                              _tabs(3) + '</div>' +
                        _tabs(2) + '</div>' +
                        _tabs(2) + '<div class="is-box-6 is-box is-bg-light is-dark-text">' +
                            _tabs(3) + '<div class="is-boxes">' +
                                _tabs(4) + '<div class="is-box-centered">' +
                                    _tabs(5) + '<div class="is-container is-builder is-content-500 container">' +
                                        _tabs(6) + '<div class="row clearfix">' +
    ...
    /* VIDEO */
		...
		'html':
                '<div class="is-section is-section-100 is-box is-bg-grey is-light-text">' +
                    _tabs(1) + '<div class="is-overlay">' +
                        ...
                        _tabs(2) + '<div class="is-overlay-content" data-module="video-bg" data-module-desc="Video Background" data-dialog-width="600px" data-dialog-height="335px" ' +
                            'data-html="' +
                                encodeURIComponent('' +
                                        _tabs(3) + '<video class="is-video-bg" playsinline autoplay muted loop>' +
                                            _tabs(4) + '<source src="[%IMAGE_PATH%]videos/example1.mp4" type="video/mp4">' +
                                        _tabs(3) + '</video>' +
                                        _tabs(3) + '<div class="is-overlay-video"></div>' +
                                    _tabs(2)) +
                            '"' +
                            'data-settings="' +
                    ...
                    _tabs(1) + '</div>' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-centered is-content-bottom is-opacity-85">' +
                            _tabs(3) + '<div class="is-container is-builder is-content-640 is-content-left container">' +
                                _tabs(4) + '<div class="row clearfix">' +
                                    _tabs(5) + '<div class="column full">' +
            		                    _tabs(6) + '<div class="display">' +
                		                    _tabs(7) + '<h1>Lorem Ipsum is simply dummy text</h1>' +
                                            _tabs(7) + '<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
            		                    _tabs(6) + '</div>' +
                                    _tabs(5) + '</div>' +
                                _tabs(4) + '</div>' +
                            _tabs(3) + '</div>' +
...

		{
		    ...
		    'html':
                '<div class="is-section is-section-100 is-shadow-1">' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-6 is-box is-bg-grey is-light-text">' +
                            _tabs(3) + '<div class="is-overlay">' +

                                _tabs(4) + '<div class="is-overlay-content" data-module="video-bg" data-module-desc="Video Background" data-dialog-width="600px" data-dialog-height="335px" ' +
                                    'data-html="' +
                                        encodeURIComponent('' +
                                                _tabs(5) + '<video class="is-video-bg" playsinline autoplay muted loop>' +
                                                    _tabs(6) + '<source src="[%IMAGE_PATH%]videos/example1.mp4" type="video/mp4">' +
                                                _tabs(5) + '</video>' +
                                                _tabs(5) + '<div class="is-overlay-video"></div>' +
                                            _tabs(4)) +
                                    '"' +
                                    'data-settings="' +
                                        encodeURIComponent('[{ "mp4": "[%IMAGE_PATH%]videos/example1.mp4", "poster": "", "overlay": 0.25}]') +
                            ...
                            _tabs(3) + '</div>' +
                            _tabs(3) + '<div class="is-boxes">' +
                                _tabs(4) + '<div class="is-box-centered is-content-bottom is-opacity-85">' +
                                    _tabs(5) + '<div class="is-container is-builder is-content-500 is-content-left container">' +
                                        _tabs(6) + '<div class="row clearfix">' +
                                            _tabs(7) + '<div class="column full">' +
            		                            _tabs(8) + '<div class="display">' +
                		                            _tabs(9) + '<h1>Lorem Ipsum is dummy text</h1>' +
...

		{
		    ...
		    'html':
                '<div class="is-section is-section-100 is-shadow-1">' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-6 is-box is-bg-grey is-dark-text">' +
                            _tabs(3) + '<div class="is-overlay">' +
		    ...
		    'html':
                '<div class="is-section is-section-100 is-shadow-1">' +
                    _tabs(1) + '<div class="is-boxes">' +
                        _tabs(2) + '<div class="is-box-6 is-box is-bg-grey is-light-text">' +
                            _tabs(3) + '<div class="is-overlay">' +
                                _tabs(4) + '<div class="is-overlay-content" data-module="code" data-module-desc="Custom HTML or Javascript " data-html="%3C!--%20EXAMPLE%3A%20Background%20Animation%20--%3E%0A%0A%3Cdiv%20style%3D%22overflow%3Ahidden%3Bwidth%3A100%25%3Bheight%3A100%25%3Bposition%3Aabsolute%3Bbackground%3Alinear-gradient(25deg%2C%23b1301c%2C%23fdecb0)%3B%22%3E%0A%3Ccanvas%20id%3D%22{id}%22%20style%3D%22width%3A100%25%3Bheight%3A100%25%3Bposition%3Aabsolute%3B%22%3E%3C%2Fcanvas%3E%0A%3C%2Fdiv%3E%0A%0A%3Cscript%3E%0A%0A(function()%20%7B%0A%0A%09var%20canvas%20%3D%20document.getElementById(&#39;{id}&#39;)%3B%0A%09var%20ctx%20%3D%20canvas.getContext(&#39;2d&#39;)%3B%0A%0A%09var%20ww%20%3D%20%24(window).width()%3B%0A%09var%20wh%20%3D%20%24(window).height()%3B%0A%0A%09canvas.width%20%3D%20ww%3B%0A%09canvas.height%3D%20wh%3B%0A%0A%09var%20partCount%20%3D%20100%3B%0A%09var%20particles%20%3D%20%5B%5D%3B%0A%0A%09window.addEventListener(&#39;resize&#39;%2C%20function()%7B%0A%09%09ww%20%3D%20%24(window).width()%3B%0A%09%09wh%20%3D%20%24(window).height()%3B%0A%09%09canvas.width%20%3D%20ww%3B%0A%09%09canvas.height%3D%20wh%3B%0A%0A%09%09clearCanvas()%3B%0A%09%09particles%20%3D%20%5B%5D%3B%0A%0A%09%09init()%3B%0A%09%7D)%3B%0A%09%0A%09particle%20%3D%20function()%7B%0A%09%09this.color%20%3D%20&#39;rgba(255%2C255%2C255%2C&#39;%2B%20Math.random()%2B&#39;)&#39;%3B%0A%09%09this.x%20%3D%20randomInt(0%2Cww)%3B%0A%09%09this.y%20%3D%20randomInt(0%2Cwh)%3B%0A%09%09this.direction%20%3D%20%7B%0A%09%09%09%22x%22%3A%20-1%20%2B%20Math.random()%20*%2012%2C%0A%09%09%09%22y%22%3A%20-1%20%2B%20Math.random()%20*%2012%0A%09%09%7D%3B%0A%09%09this.vx%20%3D%200.3%20*%20Math.random()%3B%0A%09%09this.vy%20%3D%200.3%20*%20Math.random()%3B%0A%09%09this.radius%20%3D%20randomInt(2%2C3)%3B%0A%09%09this.float%20%3D%20function()%7B%0A%09%09%09this.x%20%2B%3D%20this.vx%20*%20this.direction.x%3B%0A%09%09%09this.y%20%2B%3D%20this.vy%20*%20this.direction.y%3B%0A%09%09%7D%3B%0A%09%09this.changeDirection%20%3D%20function%20(axis)%20%7B%0A%09%09%09this.direction%5Baxis%5D%20*%3D%20-1%3B%0A%09%09%7D%3B%0A%09%0A%09%09this.boundaryCheck%20%3D%20function%20()%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20if%20(this.x%20%3E%3D%20ww)%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.x%20%3D%20ww%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.changeDirection(%22x%22)%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%7D%20else%20if%20(this.x%20%3C%3D%200)%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.x%20%3D%200%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.changeDirection(%22x%22)%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%20%20%20%20%20%20if%20(this.y%20%3E%3D%20wh)%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.y%20%3D%20wh%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.changeDirection(%22y%22)%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%7D%20else%20if%20(this.y%20%3C%3D%200)%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.y%20%3D%200%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20this.changeDirection(%22y%22)%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%20%20%7D%3B%0A%09%09%0A%09%09this.draw%20%3D%20function%20()%20%7B%0A%09%09%09ctx.beginPath()%3B%0A%09%09%09ctx.fillStyle%20%3D%20this.color%3B%0A%09%09%09ctx.arc(this.x%2C%20this.y%2C%20this.radius%2C%200%2C%20Math.PI%20*%202%2C%20false)%3B%0A%09%09%09ctx.fill()%3B%0A%09%09%7D%3B%0A%09%7D%0A%0A%09function%20init%20()%20%7B%0A%09%09createParticles()%3B%0A%09%09drawParticles()%3B%0A%09%7D%0A%0A%09function%20animate()%20%7B%0A%20%20%20%20%20%20%20%20clearCanvas()%3B%0A%20%20%20%20%20%20%20%20drawParticles()%3B%0A%20%20%20%20%20%20%20%20updateParticles()%3B%0A%20%20%20%20%20%20%20%20requestAnimationFrame(animate)%3B%0A%09%7D%0A%20%20%0A%09function%20clearCanvas()%20%7B%0A%09%09ctx.clearRect(0%2C%200%2C%20ww%2C%20wh)%3B%0A%09%7D%0A%0A%09function%20createParticles()%7B%0A%09%09for%20(i%3D0%3Bi%3CpartCount%3Bi%2B%2B)%7B%0A%09%09%09var%20p%20%3D%20new%20particle()%3B%0A%09%09%09particles.push(p)%3B%0A%09%09%7D%0A%09%7D%0A%0A%09function%20drawParticles()%20%7B%0A%09%09for%20(i%3D0%3Bi%3Cparticles.length%3Bi%2B%2B)%20%7B%0A%09%09%09p%20%3D%20particles%5Bi%5D%3B%0A%09%09%09p.draw()%3B%0A%09%09%7D%0A%09%7D%0A%0A%09function%20updateParticles()%20%7B%0A%09%09for%20(var%20i%20%3D%20particles.length%20-%201%3B%20i%20%3E%3D%200%3B%20i--)%20%7B%0A%09%09%09p%20%3D%20particles%5Bi%5D%3B%0A%09%09%09p.float()%3B%0A%09%09%09p.boundaryCheck()%3B%0A%09%09%7D%0A%09%7D%0A%0A%09function%20randomInt(min%2Cmax)%20%7B%0A%09%09return%20Math.floor(Math.random()*(max-min%2B1)%2Bmin)%3B%0A%09%7D%0A%09%0A%09init()%3B%0A%09animate()%3B%0A%0A%7D).call(this)%3B%0A%0A%3C%2Fscript%3E"></div>' +
                            _tabs(3) + '</div>' +
                            _tabs(3) + '<div class="is-boxes">' +
                                _tabs(4) + '<div class="is-box-centered is-content-bottom is-opacity-90">' +
                                    _tabs(5) + '<div class="is-container is-builder is-content-500 is-content-left container">' +
                                        _tabs(6) + '<div class="row clearfix">' +
                                            _tabs(7) + '<div class="column full">' +
            		                            _tabs(8) + '<div class="display">' +
