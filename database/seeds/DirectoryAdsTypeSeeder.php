...
class DirectoryAdsTypeSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('directory_ads_types')->truncate();

        $types = [
            ['name' => 'Sponsored Listing',  'web_id' => 0, 'width' => 200, 'height' => 200, 'description' => 'This is listing type for sponsored listing', 'title_char' => 50, 'text_char' => 300, 'status' => 1],
        ...
        foreach ($types as $type) {
            \App\Models\DirectoryAdsType::create($type);
        }
